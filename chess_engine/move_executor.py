...
class MoveExecutor:
    ...
    def handle_piece_move(self, moved_square, target_square):
        ...
        is_castling_move = self.game_state.move_validator.is_castling_move(
            moved_piece,
            moved_square,
            target_square
        )
        ...
        if is_castling_move:
            self.handle_castling(moved_piece, moved_square, target_square)
            return
    ...
    # ------------------------------- HANDLE CASTLING ----------------------------------
    ####################################################################################
    def handle_castling(self, moved_piece, moved_square, target_square):
    ...
    def _save_castling_rights_state(self):
        rights_copy = {
